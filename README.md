...
| 2. [Principal component analysis of genetic data](episodes/02-pca.md) | How do I *encode* genetic polymorphism data?<br>How do I represent the genetic polymorphism data as a matrix?*<br>How can I plot the results of PCA in a way that an insightful way? |
